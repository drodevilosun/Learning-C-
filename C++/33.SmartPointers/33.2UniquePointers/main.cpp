...
int main(){
  ...
  /*       Dog* p_dog2 = new Dog("Dog2");
    ...
    /* {
        std::unique_ptr<Dog> up_dog_x {new Dog("xxx")};
        ...
        * up_int2 = 500;
        ...
        up_dog_x->print_dog();
        std::cout << "Dog x : " << up_dog_x.get() << std::endl; // dereferencing
...
//----------------------------------------------------------------------------------
    ...
    /* std::unique_ptr<Dog> up_my_dog = std::make_unique<Dog>("My dog");
    std::cout << "My dog memory address : " << up_my_dog.get() << std::endl;
    // std::unique_ptr<Dog> up_dog_11 = std::make_unique<Dog>("Dog11");
    {
        ...
        std::unique_ptr<Dog> up_d_dog = std::move(up_my_dog);
        ...
        up_d_dog->print_dog();
        std::cout << "My dog is no nullptr : " << up_my_dog.get() << std::endl;
        std::cout << "D dog memory address : " << up_d_dog.get() << std::endl;
...
//----------------------------------------------------------------------------------
    ...
    std::unique_ptr<Dog> up_dog1 = std::make_unique<Dog>("Dog shit");
